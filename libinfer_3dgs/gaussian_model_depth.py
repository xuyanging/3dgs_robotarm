...
class GaussianModelDepth:
    ...
    def load_ply(self, path):
        ...
        self._features_dc = nn.Parameter(features_dc.transpose(1, 2).contiguous())
        self._features_rest = nn.Parameter(features_extra.transpose(1, 2).contiguous())
